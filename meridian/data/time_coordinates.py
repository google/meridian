...
def normalize_date_interval(
  ...
  """Normalizes various representations of a date interval into a canonical `date` tuple.
...
class TimeCoordinates:
  ...
  def __post_init__(self):
    if self._strict and not self.datetime_index.is_monotonic_increasing:
  ...
  def interval_days(self) -> int:
    ...
    We assume that the date index is regularly spaced. If this is not true,
    this property call will emit a warning. Returns the mode interval, in any
    case.
    """
