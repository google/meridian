  ...
  def load(self) -> input_data.InputData:
    ...
    if self.coord_to_columns.controls is not None:
      builder.with_controls(
          self.df,
          list(dict.fromkeys(self.coord_to_columns.controls)),
          self.coord_to_columns.time,
          self.coord_to_columns.geo,
      )
    if self.coord_to_columns.non_media_treatments is not None:
      builder.with_non_media_treatments(
          self.df,
          list(dict.fromkeys(self.coord_to_columns.non_media_treatments)),
          self.coord_to_columns.time,
          self.coord_to_columns.geo,
      )
    ...
    if (
      ...
      builder.with_media(
          self.df,
          list(dict.fromkeys(self.coord_to_columns.media)),
          list(dict.fromkeys(self.coord_to_columns.media_spend)),
          list(dict.fromkeys(self.media_to_channel.values())),
          self.coord_to_columns.time,
          self.coord_to_columns.geo,
      )
    ...
    if (
      ...
      builder.with_reach(
          self.df,
          list(dict.fromkeys(self.coord_to_columns.reach)),
          list(dict.fromkeys(self.coord_to_columns.frequency)),
          list(dict.fromkeys(self.coord_to_columns.rf_spend)),
          list(dict.fromkeys(self.reach_to_channel.values())),
          self.coord_to_columns.time,
          self.coord_to_columns.geo,
      )
    if self.coord_to_columns.organic_media is not None:
      builder.with_organic_media(
          self.df,
          list(dict.fromkeys(self.coord_to_columns.organic_media)),
          list(dict.fromkeys(self.coord_to_columns.organic_media)),
          self.coord_to_columns.time,
          self.coord_to_columns.geo,
      )
    if (
      ...
      builder.with_organic_reach(
          self.df,
          list(dict.fromkeys(self.coord_to_columns.organic_reach)),
          list(dict.fromkeys(self.coord_to_columns.organic_frequency)),
          list(dict.fromkeys(self.organic_reach_to_channel.values())),
          self.coord_to_columns.time,
          self.coord_to_columns.geo,
      )
