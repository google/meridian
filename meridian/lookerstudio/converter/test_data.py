...
from meridian.lookerstudio.converter import constants as cc
from meridian.proto.mmm.v1.common import date_interval_pb2 as date_interval_pb
from meridian.proto.mmm.v1.common import estimate_pb2 as estimate_pb
from meridian.proto.mmm.v1.common import kpi_type_pb2 as kpi_type_pb
from meridian.proto.mmm.v1.common import target_metric_pb2 as target_metric_pb
from meridian.proto.mmm.v1.fit import model_fit_pb2 as fit_pb
from meridian.proto.mmm.v1.marketing import marketing_data_pb2 as marketing_data_pb
from meridian.proto.mmm.v1.marketing.analysis import kpi_outcome_pb2 as kpi_pb
from meridian.proto.mmm.v1.marketing.analysis import marketing_analysis_pb2 as marketing_pb
from meridian.proto.mmm.v1.marketing.analysis import media_analysis_pb2 as media_pb
from meridian.proto.mmm.v1.marketing.analysis import non_media_analysis_pb2 as non_media_pb
from meridian.proto.mmm.v1.marketing.analysis import response_curve_pb2 as response_curve_pb
from meridian.proto.mmm.v1.marketing.optimization import budget_optimization_pb2 as budget_pb
from meridian.proto.mmm.v1.marketing.optimization import constraints_pb2 as constraints_pb
from meridian.proto.mmm.v1.marketing.optimization import reach_frequency_optimization_pb2 as rf_pb
...
REVENUE_KPI_OUTCOME = create_kpi_outcome(
...
NON_REVENUE_KPI_OUTCOME = create_kpi_outcome(
    incremental_outcome=100.0,
    pct_of_contribution=0.1,
    effectiveness=4.4,
    roi=10.0,
...
def create_media_analysis(
    ...
    make_revenue_kpi_outcome: bool = True,
    make_non_revenue_kpi_outcome: bool = True,
  ...
  if make_non_revenue_kpi_outcome:
    outcomes.append(
        create_kpi_outcome(
            incremental_outcome=100.0 * multiplier,
            pct_of_contribution=0.1 * multiplier,
...
MEDIA_ANALYSES_NONREVENUE = [
    create_media_analysis(
        ...
        (idx + 1.2),
        make_revenue_kpi_outcome=False,
    )
    for (idx, channel) in enumerate(MEDIA_CHANNELS)
]
...
ALL_CHANNELS_ANALYSIS_NONREVENUE = create_media_analysis(
    c.ALL_CHANNELS, multiplier=12, make_revenue_kpi_outcome=False
)

BASELINE_NONREVENUE_OUTCOME = create_kpi_outcome(
...
BASELINE_REVENUE_OUTCOME = create_kpi_outcome(
