...
from meridian.proto.mmm.v1 import mmm_pb2 as mmm_pb
...
class KpiOutcome:
  ...
  kpi_outcome_proto: kpi_pb.KpiOutcome

  @property
  def is_revenue_kpi(self) -> bool:
    return self.kpi_outcome_proto.kpi_type == kpi_type_pb.REVENUE

  @property
  def is_nonrevenue_kpi(self) -> bool:
    return self.kpi_outcome_proto.kpi_type == kpi_type_pb.NON_REVENUE

  @property
  def contribution_pb(self) -> kpi_pb.Contribution:
    return self.kpi_outcome_proto.contribution

  @property
  def effectiveness_pb(self) -> kpi_pb.Effectiveness:
...
class _OutcomeMixin(abc.ABC):
  ...
  @property
  @abc.abstractmethod
  def _kpi_outcome_pbs(self) -> list[kpi_pb.KpiOutcome]:
