...
class ContextTest(
  ...
  def test_get_media_transformation_divisor_success(
    ...
    divisor = model_context.get_media_transformation_divisor(channel_name)
    ...
    test_utils.assert_allclose(divisor, expected)
  ...
  @parameterized.named_parameters(
      dict(
          ...
          error_msg=(
              "Non-media variables are not normalized by a population-scaled"
              " median divisor"
          ),
      ),
      dict(
          ...
          error_msg=(
              "Control variables are not normalized by a population-scaled"
              " median divisor"
          ),
      ),
      dict(
  ...
  def test_get_media_transformation_divisor_failure(
    ...
    with self.assertRaisesRegex(ValueError, error_msg):
      model_context.get_media_transformation_divisor(channel_name)
