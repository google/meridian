...
class Meridian:
  ...
  Attributes:
    model_context: A `ModelContext` object containing model context.
  ...
  def __init__(
    ...
    self.model_context = context.ModelContext(
        input_data, model_spec if model_spec else spec.ModelSpec()
    )
  ...
  def input_data(self) -> data.InputData:
    return self.model_context.input_data

  @property
  def model_spec(self) -> spec.ModelSpec:
    return self.model_context.model_spec
  ...
  def media_tensors(self) -> media.MediaTensors:
    return self.model_context.media_tensors

  @property
  def rf_tensors(self) -> media.RfTensors:
    return self.model_context.rf_tensors

  @property
  def organic_media_tensors(self) -> media.OrganicMediaTensors:
    return self.model_context.organic_media_tensors

  @property
  def organic_rf_tensors(self) -> media.OrganicRfTensors:
    return self.model_context.organic_rf_tensors

  @property
  def kpi(self) -> backend.Tensor:
    return self.model_context.kpi

  @property
  def revenue_per_kpi(self) -> backend.Tensor | None:
    return self.model_context.revenue_per_kpi

  @property
  def controls(self) -> backend.Tensor | None:
    return self.model_context.controls

  @property
  def non_media_treatments(self) -> backend.Tensor | None:
    return self.model_context.non_media_treatments

  @property
  def population(self) -> backend.Tensor:
    return self.model_context.population

  @property
  def total_spend(self) -> backend.Tensor:
    return self.model_context.total_spend

  @property
  def total_outcome(self) -> backend.Tensor:
    return self.model_context.total_outcome

  @property
  def n_geos(self) -> int:
    return self.model_context.n_geos

  @property
  def n_media_channels(self) -> int:
    return self.model_context.n_media_channels

  @property
  def n_rf_channels(self) -> int:
    return self.model_context.n_rf_channels

  @property
  def n_organic_media_channels(self) -> int:
    return self.model_context.n_organic_media_channels

  @property
  def n_organic_rf_channels(self) -> int:
    return self.model_context.n_organic_rf_channels

  @property
  def n_controls(self) -> int:
    return self.model_context.n_controls

  @property
  def n_non_media_channels(self) -> int:
    return self.model_context.n_non_media_channels

  @property
  def n_times(self) -> int:
    return self.model_context.n_times

  @property
  def n_media_times(self) -> int:
    return self.model_context.n_media_times

  @property
  def is_national(self) -> bool:
    return self.model_context.is_national

  @property
  def knot_info(self) -> knots.KnotInfo:
    return self.model_context.knot_info

  @property
  def controls_transformer(
      self,
  ) -> transformers.CenteringAndScalingTransformer | None:
    return self.model_context.controls_transformer

  @property
  def non_media_transformer(
      self,
  ) -> transformers.CenteringAndScalingTransformer | None:
    return self.model_context.non_media_transformer

  @property
  def kpi_transformer(self) -> transformers.KpiTransformer:
    return self.model_context.kpi_transformer

  @property
  def controls_scaled(self) -> backend.Tensor | None:
    return self.model_context.controls_scaled

  @property
  def non_media_treatments_normalized(self) -> backend.Tensor | None:
    return self.model_context.non_media_treatments_normalized

  @property
  def kpi_scaled(self) -> backend.Tensor:
    return self.model_context.kpi_scaled

  @property
  def media_effects_dist(self) -> str:
    return self.model_context.media_effects_dist

  @property
  def unique_sigma_for_each_geo(self) -> bool:
    return self.model_context.unique_sigma_for_each_geo

  @property
  def baseline_geo_idx(self) -> int:
    return self.model_context.baseline_geo_idx

  @property
  def holdout_id(self) -> backend.Tensor | None:
    return self.model_context.holdout_id

  @property
  def adstock_decay_spec(self) -> adstock_hill.AdstockDecaySpec:
    return self.model_context.adstock_decay_spec

  @property
  def prior_broadcast(self) -> prior_distribution.PriorDistribution:
    return self.model_context.prior_broadcast
  ...
  def _validate_roi_priors_non_revenue(self):
    ...
    if (
      ...
      if (
        ...
        self.model_context.set_total_media_contribution_prior = True
        warnings.warn(
