...
class Meridian:
  ...
  def __init__(
    ...
    self._model_context._warn_setting_ignored_priors()
    self._model_context._validate_mroi_priors_non_revenue()
    self._model_context._validate_roi_priors_non_revenue()
    self._model_context._check_media_prior_support()
