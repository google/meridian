...
class ModelSpec:
  ...
  def effective_organic_media_prior_type(self) -> str:
    ...
    if self.use_total_treatment_contribution_prior:
      return constants.TREATMENT_PRIOR_TYPE_CONTRIBUTION
    elif self.effective_organic_media_prior_type is not None:
      return self.effective_organic_media_prior_type
    else:
      return constants.TREATMENT_PRIOR_TYPE_CONTRIBUTION
  ...
  def effective_organic_rf_prior_type(self) -> str:
    ...
    if self.use_total_treatment_contribution_prior:
      return constants.TREATMENT_PRIOR_TYPE_CONTRIBUTION
    elif self.effective_organic_rf_prior_type is not None:
      return self.effective_organic_rf_prior_type
    else:
      return constants.TREATMENT_PRIOR_TYPE_CONTRIBUTION
  ...
  def effective_non_media_treatments_prior_type(self) -> str:
    ...
    if self.use_total_treatment_contribution_prior:
      return constants.TREATMENT_PRIOR_TYPE_CONTRIBUTION
    elif self.effective_non_media_treatments_prior_type is not None:
      return self.effective_non_media_treatments_prior_type
    else:
      return constants.TREATMENT_PRIOR_TYPE_CONTRIBUTION
