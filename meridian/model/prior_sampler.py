...
class PriorDistributionSampler:
  ...
  def _sample_media_priors(
    ...
    if prior_type == constants.TREATMENT_PRIOR_TYPE_COEFFICIENT:
      ...
      beta_m_value = mmm.calculate_beta_or_gamma_x(
          is_non_media=False,
  ...
  def _sample_rf_priors(
    ...
    if prior_type == constants.TREATMENT_PRIOR_TYPE_COEFFICIENT:
      ...
      beta_rf_value = mmm.calculate_beta_or_gamma_x(
          is_non_media=False,
  ...
  def _sample_organic_media_priors(
    ...
    if prior_type == constants.TREATMENT_PRIOR_TYPE_COEFFICIENT:
      ...
      beta_om_value = mmm.calculate_beta_or_gamma_x(
          is_non_media=False,
  ...
  def _sample_organic_rf_priors(
    ...
    if prior_type == constants.TREATMENT_PRIOR_TYPE_COEFFICIENT:
      ...
      beta_orf_value = mmm.calculate_beta_or_gamma_x(
          is_non_media=False,
  ...
  def _sample_non_media_treatments_priors(
    ...
    if prior_type == constants.TREATMENT_PRIOR_TYPE_COEFFICIENT:
      ...
      gamma_n_value = mmm.calculate_beta_or_gamma_x(
          is_non_media=True,
