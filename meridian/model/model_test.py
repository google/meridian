  ...
  def test_adstock_hill_media_missing_required_n_times_output(self):
    with self.assertRaisesRegex(
      ...
      meridian.adstock_hill_media(
          ...
          adstock_decay_functions=meridian.adstock_decay_spec.media,
      )
  ...
  def test_adstock_hill_rf_missing_required_n_times_output(self):
    with self.assertRaisesRegex(
      ...
      meridian.adstock_hill_rf(
          ...
          adstock_decay_functions=meridian.adstock_decay_spec.rf,
      )
...
class NonPaidModelTest(
  ...
  def test_get_joint_dist_with_log_prob_non_media(
    ...
    transformed_organic_media = meridian.adstock_hill_media(
        ...
        adstock_decay_functions=meridian.adstock_decay_spec.organic_media,
    )[0, :, :, :]
    transformed_organic_reach = meridian.adstock_hill_rf(
        ...
        adstock_decay_functions=meridian.adstock_decay_spec.organic_rf,
    )[0, :, :, :]
...
class AdstockDecayFunctionsFromChannelMappingTest(parameterized.TestCase):
  ...
  @parameterized.product(
      **data_test_utils.ADSTOCK_DECAY_FUNCTION_CASES,
