...
class ModelSpecTest(parameterized.TestCase):
  ...
  def test_spec_inits_with_default_params(self):
    ...
    self.assertEqual(model_spec.effective_organic_media_prior_type, "contribution")
    self.assertEqual(model_spec.effective_organic_rf_prior_type, "contribution")
    self.assertEqual(model_spec.effective_non_media_treatments_prior_type, "contribution")
  ...
  def test_spec_inits_valid_prior_type_works(
    ...
    self.assertEqual(model_spec.effective_organic_rf_prior_type, organic_rf_prior_type)
    self.assertEqual(
  ...
  def test_spec_inits_use_total_treatment_contribution_overwrites_prior_types(
    ...
    model_spec = spec.ModelSpec(
        ...
        media_prior_type="mroi",
        rf_prior_type="coefficient",
        effective_organic_media_prior_type="coefficient",
        effective_organic_rf_prior_type="coefficient",
        effective_non_media_treatments_prior_type="coefficient",
    )
