...
def _draw_random_holdout(
  ...
  Note that random samples are drawn sequentially in the order geos appear in
  the input data coordinates; permuting geo order will produce different samples
  for the same seed.
