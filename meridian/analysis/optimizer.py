...
class BudgetOptimizer:
  ...
  def optimize(
    ...
    n_paid_channels = len(
        self._analyzer._model_context.input_data.get_all_paid_channels()
    )
  ...
  def create_optimization_tensors(
    ...
    n_geos = self._analyzer._model_context.n_geos
  ...
  def _validate_grid(
    ...
    filled_data = new_data.validate_and_fill_missing_data(
        ...
        model_context=self._analyzer._model_context,
    )
    paid_channels = (
        self._analyzer._model_context.input_data.get_all_paid_channels()
    )
    ...
    hist_spend = self._analyzer.get_aggregated_spend(
        ...
        selected_times=selected_times,
        include_media=self._analyzer._model_context.n_media_channels > 0,
        include_rf=self._analyzer._model_context.n_rf_channels > 0,
    ).data
  ...
  def _allocate_tensor_by_population(
    ...
    population = self._analyzer._model_context.input_data.population
