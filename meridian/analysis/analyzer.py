    ...
    if data_tensors.media is not None:
      combined_medias.append(
          self._meridian.adstock_hill_media(
              ...
              adstock_decay_functions=self._meridian.adstock_decay_spec.media,
    ...
    if data_tensors.reach is not None:
      combined_medias.append(
          self._meridian.adstock_hill_rf(
              ...
              adstock_decay_functions=self._meridian.adstock_decay_spec.rf,
              n_times_output=n_times_output,
          )
      )
    ...
    if data_tensors.organic_media is not None:
      combined_medias.append(
          self._meridian.adstock_hill_media(
              ...
              adstock_decay_functions=self._meridian.adstock_decay_spec.organic_media,
              n_times_output=n_times_output,
          )
      )
    ...
    if data_tensors.organic_reach is not None:
      combined_medias.append(
          self._meridian.adstock_hill_rf(
              ...
              adstock_decay_functions=self._meridian.adstock_decay_spec.organic_rf,
              n_times_output=n_times_output,
          )
      )
