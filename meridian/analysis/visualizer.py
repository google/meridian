...
class ModelFit:
  ...
  def plot_model_fit(
    ...
    # Create a wrapper chart to define the base properties.
    base = alt.Chart(model_fit_df, width=c.VEGALITE_FACET_EXTRA_LARGE_WIDTH)

    # Define the selection for the tooltip.
