...
from lookerstudio.converter import mmm_converter
from lookerstudio.converter.dataframe import budget_opt_converters
from lookerstudio.converter.dataframe import marketing_analyses_converters
from lookerstudio.converter.dataframe import rf_opt_converters
import pandas as pd
...
class DataFrameModelConverter(mmm_converter.ModelConverter[pd.DataFrame]):
  ...
  *   "rf_opt_results"
  ...
  _converters: Sequence[type[dataframe.Converter]] = (
