...
"""Defines converters for marketing analyses output."""
...
class ModelDiagnosticsConverter(dataframe.Converter):
...
class ModelFitConverter(dataframe.Converter):
...
class _MarketingAnalysisConverter(dataframe.Converter, abc.ABC):
