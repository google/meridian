  ...
  def _handle_marketing_analyses(
    ...
    for marketing_analysis in analyses:
      ...
      baseline_kpi_outcome: mmm.KpiOutcome = (
          marketing_analysis.baseline_analysis.revenue_kpi_outcome
          if self._is_revenue_kpi
          else marketing_analysis.baseline_analysis.non_revenue_kpi_outcome
      )
      ...
      media_analysises = [
          ...
          for (
              channel_name,
              analysis,
          ) in marketing_analysis.channel_mapped_media_analyses.items()
      ]
      non_media_analysises = [
          (
              channel_name,
              analysis,
          )
          for (
              channel_name,
              analysis,
          ) in marketing_analysis.channel_mapped_non_media_analyses.items()
          if channel_name != c.BASELINE
      ]
      all_analysises = media_analysises + non_media_analysises
      for (
          channel,
          media_analysis,
      ) in all_analysises:
